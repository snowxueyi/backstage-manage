...
export default  opt=> {
    let iframe;
    if(document&&document.getElementById('printwindow')){
        iframe = document.getElementById('printwindow');  
    }else
    {
    ...
    iframe.contentDocument.body.innerHTML=baseStr;
